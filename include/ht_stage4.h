...
#include "bn_regular_bg_items_stage4_intro.h"
#include "bn_regular_bg_items_stage4_outro.h"
#include "bn_regular_bg_items_stage4_bg_tiles.h"
#include "bn_regular_bg_items_stage4_0.h"
#include "bn_regular_bg_items_stage4_1.h"
#include "bn_regular_bg_items_stage4_2.h"
#include "bn_regular_bg_items_stage4_3.h"
...
private:
    ...
    bn::vector<ht::assassin, 2> _e_assassin;

    void _stage4_0_create_enemy();
    void _stage4_1_create_enemy();
    void _stage4_2_create_enemy();
    void _stage4_3_create_enemy();
};
