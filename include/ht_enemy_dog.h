#ifndef HT_ENEMY_DOG_H
#define HT_ENEMY_DOG_H
...
#include "bn_sprite_items_dog_hard.h"
#include "bn_sprite_items_dog_insane.h"
...
{
public:
    dog(ht::enemy::grade grade_val = grade::NORMAL);
    dog(ht::enemy::grade grade_val,
...
private:
    ...
    struct ht::trace_manager::area_t* _area;
    bn::fixed_point _rand_pos;
