#ifndef HT_ENEMY_CHASER_H
#define HT_ENEMY_CHASER_H
...
#include "bn_sprite_items_chaser.h"
#include "bn_sprite_items_chaser_hard.h"
#include "bn_sprite_items_chaser_insane.h"
...
{
public:
    chaser(ht::enemy::grade grade_val = grade::NORMAL);
    chaser(ht::enemy::grade grade_val,
